...
function Choose() {
    ...
    const imag = isVisible ? (<div className="hiden">
                                    <img onClick={()=>history.push('/buycrypto/mobile')} src={visa} alt="visa"/>
                                    <img onClick={()=>history.push('/buycrypto/mobile')} src={master} alt="mster"/>
                                    <img onClick={()=>history.push('/buycrypto/mobile')} src={google} alt="google"/>
                                    <img onClick={()=>history.push('/buycrypto/mobile')} src={apple} alt="apple"/>
                                </div>
                            ) : '';
    ...
    const imag2 = isVisible2 ? (<div className="hiden">
                                    <img onClick={()=>history.push('/buycrypto/mobile')} src={mtn} alt="mtn"/>
                                    <img onClick={()=>history.push('/buycrypto/mobile')} src={moov} alt="moov"/>
                                    <img onClick={()=>history.push('/buycrypto/mobile')} src={mobi} alt="mobi"/>
                                    <img onClick={()=>history.push('/buycrypto/mobile')} src={yup} alt="yup"/>
                                    <img onClick={()=>history.push('/buycrypto/mobile')} src={orang} alt="orang"/>
                                </div>
                            ) : '';
        ...
        <div id="choose" className="choose" style={{color:'#707070'}}>
            ...
            <div className="chooses">
                <div className="credit-card way">
                    <div className="way2">
                        <div className="head" onClick={()=>history.push('/buycrypto/mobile')}>
                            <h2>{t('chosesSous1')}</h2>
