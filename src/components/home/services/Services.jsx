    ...
    return (
        <div className="services" id="services">
            ...
            <div className="services-container">
                <div className="servic"  onClick={()=>hisoty.push('/buycrypto')} data-aos="flip-left" data-aos-duration="2000" >
                    <h3> {t('servicesTitle1')} </h3>
                    <p>{t('sousService1')}</p>
                    <div className="icone" ><img src={buy} alt='buy' width='45px' /> </div>
                </div>
                <div className="service" onClick={()=>hisoty.push('/sellcrypto')} data-aos="flip-left" data-aos-duration="2000" >
                ...
                <div className="service" onClick={()=>hisoty.push('/sendmoney')} data-aos="flip-left" data-aos-duration="2000" >
